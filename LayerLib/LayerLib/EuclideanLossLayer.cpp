...
namespace MMALab
{
        EuclideanLossLayer::EuclideanLossLayer(string name)
        {
                mName = name;
                mType = MMALab::EUCLIDEAN_LOSS;
                mParam = new EuclideanLossParam();
        }

        EuclideanLossLayer::EuclideanLossLayer()
        {
                mType = MMALab::EUCLIDEAN_LOSS;
                mParam = new EuclideanLossParam();
        }
        ...
        string EuclideanLossLayer::convet2CaffeFormat()
        {
